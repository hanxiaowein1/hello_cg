...
int main()
{
    ...
    {
        Mesh::Vertex_index v = m.add_vertex(Kernel::Point_3(0, 0, i+1));
        if (i == 3)
        {
            u = v;
        }
    ...
    Mesh::Property_map<Mesh::Vertex_index, bool> removed = m.property_map<Mesh::Vertex_index, bool>("v:removed").first;
